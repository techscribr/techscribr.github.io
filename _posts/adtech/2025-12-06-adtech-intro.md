...
## 5. A Deeper Look at how the SSP Operates
...
## 6. Understanding Metrices on Both Sides
...
We’ve seen how the SSP, DSP work at a high level. In our next article, we’ll dive into the internal architecture of these platforms - specifically how **Ad Servers** and **SSPs** manage inventory and *Direct Deals* versus *programmatic auctions*.
